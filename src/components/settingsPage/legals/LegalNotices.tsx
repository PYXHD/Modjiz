    ...
    <div className={styles.container}>
      ...
      <div className={styles.contentContainer}>
        <div className={styles.subContainer}>
          ...
          <div className="text-body">CHARVOT Marc - pyxhd@oultook.fr</div>
        </div>

        <div className={styles.subContainer}>
          <h2>Hébergement</h2>
          <div>
            <div className="text-body">L'application est hébergée par :</div>
            <div className="text-body">GitHub Inc.</div>
